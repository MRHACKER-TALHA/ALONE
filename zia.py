...
logo = """ -----------------------------•◈•
(  __)\\ ____--------------_------------•◈•
|__(~)    •||•THE - MR.H4CK3R -OFFICAL------•◈•
|__\~~) •||•TALHA - SYED ZIAUDDIN---------------•◈•
|__(-----\  •◈•------SYED SAFIULLAH------•◈•
|__~~~\ •◈•-----█-------⑦-------█------•◈•
|__~~~\ •◈•-----█-------⑧-------█------•◈•
|__~~~\ •◈•-----█-------⑥-------█------•◈•
\033[1;91m=======================================
\033[1;96mAuthor  \033[1;93m: \033[1;92m. MR.ZIA BHI
\033[1;96mInstagram \033[1;93m: \033[1;Flow. MR.TALHA
...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;96m[●] \x1b[1;93m PLEASE WEIT \x1b[1;97m"+o),;sys.stdout.flush();time.sleep(1)
...
def pilih_super():
	...
	print"\033[1;96m[+] \033[1;92mTotal OK/\x1b[1;93mCP \033[1;91m: \033[1;92m"+str(len(CP))+"\033[1;97m/\033[1;93m"+str(len(OK))
